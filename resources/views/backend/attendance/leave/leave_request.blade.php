...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-validation-attendance">
                            ...
                            <form class="form-leave-request" action="{{ url('leave-request-add') }}" method="POST" enctype="multipart/form-data">
                                @csrf
    ...
    <script>
        ...
        // Ingat bulan dimulai dari 0 (Januari adalah 0)
        ...
        const defaultValueStart = `${year}-${month}-${day}T${hours}:${minutes}`;
        ...
        const defaultValueEnd = `${year}-${month}-${day}T${hoursEnd}:${minutes}`;
        datetimeend.value = defaultValueEnd;

        // batasi agar tidak dapat memilih dibawah tanggal saat ini
